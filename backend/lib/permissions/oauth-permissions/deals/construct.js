...
const { OAuthScope } = require('aws-cdk-lib/aws-cognito');

/**
 * @typedef {Object} DealsOAuthPermissionsProps
 * @property {import('aws-cdk-lib/aws-cognito').IUserPoolResourceServer} resourceServer - Deals Resource Server
 */
 ...
 */
class DealsOAuthPermissionsConstruct extends Construct {
...
module.exports = DealsOAuthPermissionsConstruct;
